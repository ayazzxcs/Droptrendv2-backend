...
function isAliExpressUiOrPromotionalTitle(value) {
  ...
  const exact = new Set([
    "dollar express", "quality trust", "quality and trust", "free with any purchase",
    "with any purchase", "shopper exclusive", "new shopper exclusive", "welcome deal",
    "welcome deals", "save extra", "extra off", "top selling", "top ranking",
    "super deals", "limited offer", "limited offers", "more to love", "recommended for you",
    "you may also like", "similar items", "see preview", "add to cart", "buy now",
    "shop now", "view more", "view all", "free shipping", "shipping from", "choice", "sponsored"
  ]);
...
function dedupeWithin(list) {
  ...
  for (const raw of Array.isArray(list) ? list : []) {
    ...
    if (sourceName(p) === "AliExpress" && isAliExpressUiOrPromotionalTitle(getName(p))) continue;
