...
const INITIAL_PRODUCT_KEYWORD_SLOTS = Number(
  process.env.ALIEXPRESS_INITIAL_PRODUCT_KEYWORD_SLOTS ||
  Math.max(1, Math.ceil(MAX_PRODUCTS / Math.max(1, PRODUCTS_PER_KEYWORD)))
);
