...
console.log(`Merged ${googleSignals.length} Google signals and ${amazonSignals.length} monthly Amazon signals into ${merged.length} products with combined multi-keyword Google Trends scoring. Duplicate usedKeyword matches are deduped per product.`);
