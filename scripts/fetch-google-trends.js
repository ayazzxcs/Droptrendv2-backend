...
// Strict mode: only variants with meaningful (non-generic) word overlap are accepted.
// Products with no relevant trend data get no Google score.
...
writeJson("google-trends-meta.json", {
  ...
  note: "Strict mode: only variants with at least one meaningful (non-generic) word overlap are accepted. Products without any relevant variant get no Google score.",
