...
// Strict hybrid mode: variant accepted if meaningful overlap > 0 OR total overlap >= 3.
// Uses product-specific title to prevent false matches.
...
function pickBestVariantSignal(signals, originalKeyword, originalTitle) {
  ...
  // If title has no meaningful words, fallback to highest score.
  if (meaningfulTitleWords.size === 0) {
