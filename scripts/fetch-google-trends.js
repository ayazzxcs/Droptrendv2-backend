...
writeJson("google-trends-meta.json", {
  ...
  note: "Stricter product-title validation with generic category-word blocking, safe single-word fallback, and IDF-weighted overlap. Uses full product titles. No Jaro-Winkler fallback.",
