...
// Chunking fix:
// If GitHub Actions runs several "Fetch Google Trends chunk" jobs, each job must
// receive a different chunk index. Without this, every job starts at keyword 0
// and fetches the same keywords again.
const EXPLICIT_CHUNK_START = intEnv(["GOOGLE_TRENDS_CHUNK_START", "GOOGLE_TRENDS_OFFSET"], -1);
const EXPLICIT_CHUNK_SIZE = intEnv(["GOOGLE_TRENDS_CHUNK_SIZE"], 0);
...
// Use 0 if your matrix is [0,1,2,...]. Use 1 if your matrix is [1,2,3,...].
...
if (EXPLICIT_CHUNK_START >= 0 && EXPLICIT_CHUNK_SIZE > 0) {
